...
function initMap() {
  try {
    ...
    if (container) {
      ...
      window.markerImage = new kakao.maps.MarkerImage("/public/marker/marker.svg", new kakao.maps.Size(75, 30));
      window.redmarkerImage = new kakao.maps.MarkerImage("/public/marker/red-marker.svg", new kakao.maps.Size(75, 30));
    }
  } catch (error) {
